...
var Popover = /*#__PURE__*/function () {
  ...
  _createClass(Popover, [{
    ...
    value: function showPopover(element) {
      var id = Math.round(performance.now());
      ...
      popoverElement.style.top = "".concat(top - popoverElement.offsetHeight - 5, "px");
      popoverElement.style.left = "".concat(right - element.offsetWidth, "px");
      popoverElement.style.width = "".concat(element.offsetWidth, "px");
    ...
    value: function removePopover(id) {
      var popoverActive = this.popover.find(function (popover) {
        return popover.id === id;
      });
      popoverActive.element.remove();
      this.popover = this.popover.filter(function (popover) {
        return popover.id !== id;
      });
    }
  }]);
...
var popoverFactory = new Popover();
...
_toConsumableArray(buttons).forEach(function (button) {
  button.addEventListener('click', function (e) {
    ...
    if (actialPopover.includes(+e.target.dataset.id)) {
      ...
      actialPopover = actialPopover.filter(function (item) {
